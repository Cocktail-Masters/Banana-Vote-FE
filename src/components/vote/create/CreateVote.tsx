...
const CreateVote = () => {
  ...
  return (
    <div className="m-10 flex flex-col">
      <div className="my-4 flex text-2xl font-bold">투표생성</div>
      <div className="flex flex-col gap-8 rounded-2xl border border-gray-300 p-10 drop-shadow-lg">
        ...
        <input
          className=" placeholder-font-bold h-16 rounded-2xl border-2 border-solid px-6 text-2xl placeholder-gray-400 outline-[#FFA45B]"
          type="text"
          placeholder="제목"
